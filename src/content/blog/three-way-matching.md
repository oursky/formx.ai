...
Here’s a full breakdown of 3-way AP:
  ...
  1. Send the purchase order to the supplier detailing what’s to be ordered.
  2. Receive the goods or services with an accompanying delivery receipt. The invoice is sometimes sent just before delivery, or with it.
  3. Check the amount that’s outstanding across the PO, invoice, and delivery receipt, as well as the items being charged for, the business referenced, etc. All the crucial details that pertain to the transaction must be cross-checked.
  4. If any aspects don’t match, the whole process needs to go back a step. This is when an accounting department will check in with the vendor and investigate any discrepancies further.
  5. Once all three financial documents match up, only then can the transaction be sent for approval.



### Example Showing Three-Way Matching in Action
...
For the sake of better illustrating the process, here’s an example of 3-way matching in action with Pencil’s Down, a fictional stationery store:
  ...
  1. Pencil’s Down put in an order with Lighting Fire for new lights to be installed in their shop. They sent a PO outlining the lights they were ordering with the amounts quoted not only for those goods but for the labor to install them.
  2. Lighting Fire came on site with the lights and at the end of installing everything, left a delivery receipt and invoice for the accounting department at the stationery store.
  3. The accounting department compared all the documents relating to the work done by the lighting and electrical company and noticed a discrepancy: though the final amount due on all the documents was the same, the invoice and receipt did not include the same goods mentioned on the PO.
  4. The accounting department launched an investigation and discovered that Lighting Fire had over-shot their quote and to avoid the issue, had instead just done less work than was asked for.
  5. Since they had already approved the PO in an email, this was fraudulent activity as they hadn’t accurately represented themselves or the amount being asked for.
  6. An agreement was made in which the stationery store would only pay for what had been delivered with the prices outlined in the PO. Once all documents had been updated and checked again, only then was the final transaction approved.
...
### Reduces Risk of Incorrect Payments
