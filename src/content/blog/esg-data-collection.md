---
title: "How to Plan and Do ESG Data Collection Right?"
description: "Learn more about why collecting ESG data is essential nowadays and how to execute it with automated solutions."
excerpt: "Learn more about why collecting ESG data is essential nowadays and how to execute it with automated solutions."
category: automation
author: FormX
date: 2025-02-10
lastmod: 2024-03-28
featured_image: "/images/blog/6513c6234a095aedb4bc0aee_esg-hexagon.jpeg"
featured_image_alt: "How to Plan and Do ESG Data Collection Right?"
canonical_url: "/blog/esg-data-collection"
---
...
The most salient aspect of ESG in terms of current trends is data that shows how a company is impacting the environment and addressing climate change issues. With regard to the proposed SEC regulations, some of the data sources that are important include:
  ...
  * Greenhouse gas emissions – those that fall into Scope 1 or 2, and then Scope 3 emissions if the company has set a reduction target for it.
  * The financial impact of severe weather and natural conditions. For example, a weather event slowing or damaging goods in transit.
  * Data and support plans on any climate-related claims a business advertises itself with e.g., net-zero emissions.
...
Because of the scope of ESG data and the regulations it often falls under, it’s generally recommended that companies build a full ESG data strategy. Here’s how:
  ...
  1. Compile your business's ESG goals while accounting for the regulations or laws you need to meet.
  2. Assess what data you have and where new data sources need to be added.
  3. Develop a data collection strategy that ensures accuracy and traceability, and can be easily repeated.
  4. Ensure that all data collected is in a standardized format.
  5. Consider using ESG analytics and reporting software.
...
### The Expanse of Data and Formats
...
### Data is Auditing Ready

As PWC showed, [73%](<https://www.pwc.com/us/en/services/esg/library/esg-data-collection-reporting.html>) of investors feel that disclosures of KPIs and ESG metrics should have the same reasonable assurance as financial statement audits. Auditing in ESG is becoming an increasingly regular occurrence and, as such, the data needs to be ready for it.
