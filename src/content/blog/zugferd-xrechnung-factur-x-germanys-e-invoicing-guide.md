...
For businesses preparing to adopt these standards, several steps are necessary:
  ...
  1. Ensure accounting software can generate the required formats
  2. Train staff on new invoicing procedures
  3. Consider using PEPPOL (Pan-European Public Procurement Online) for efficient invoice distribution
  4. Review and update internal processes to accommodate e-invoicing workflows
